...
public class LoggingAspect
{
    ...
    @Around(value = "@within(com.lambdaschool.school.logging.Loggable) || @annotation(com.lambdaschool.school.logging.Loggable)")
    public Object around(ProceedingJoinPoint proceedingJoinPoint) throws Throwable
    {
        ...
        LogWriter.write(proceedingJoinPoint.getTarget()
                                           .getClass(),
                        logLevel,
                        star + method.getName() + "() start execution" + star);
        ...
        LogWriter.write(proceedingJoinPoint.getTarget()
                                           .getClass(),
                        logLevel,
                        star + method.getName() + "() finished execution and takes " + (endTime - startTime) + " millis time to execute " + star);
